...
class Bootstrap {
  constructor() {
    ...
    dotenv.config();
    const DB_HOST =
      "db-mysql-sgp1-83374-do-user-4785916-0.a.db.ondigitalocean.com";
    ...
    const ePath = path_1.default.join(
      __dirname,
      "../core/entities/**/*{.ts,.js}"
    );
    console.log("===>", ePath);
      ...
      try {
        return new Promise((resolve, reject) =>
          __awaiter(this, void 0, void 0, function* () {
            ...
            this.hashPassword(password, (err, passwordHashed) =>
              __awaiter(this, void 0, void 0, function* () {
                if (err) {
                  ...
                  yield qryManager
                    ...
                    .catch((error) => {
                      return reject(
                        new Error(
                          `Student or Staff mapping not match. please select Student or Staff ${error}`
                        )
                      );
                    });
                }
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        const res = yield qryManager
          ...
          .into(Caste_1.Caste)
          .values([
            { name: "Agamudayar including Thozhu or Thuluva Vellala" },
            ...
            {
              name:
                "Boyas (except Tiruchirappalli, Karur, Perambalur, Pudukkottai, The Nilgiris, Salem, Namakkal and Dharmapuri and Krishnagiri Districts)",
            },
            {
              name:
            ...
            { name: "Gounder" },
            { name: "Gowda (including Gammala, Kalali and Anuppa Gounder)" },
            { name: "Hegde" },
            { name: "Idiga" },
            ...
            {
              name:
                "Kallar, Easanattu Kallar, Gandharvakottai Kallars (except Thanjavur, Nagapattinam, Thiruvarur and Pudukkottai Districts)",
            },
            ...
            { name: "Kani, Kanisu, Kaniyar Panikkar" },
            ...
            {
              name:
                "Kongu Vellalars (including Vellala Gounder, NattuGounder, Narambukatti Gounder, Tirumudi Vellalar, Thondu Vellalar, Pala Gounder, Poosari Gounder, Anuppa Vellala Gounder, Padaithalai, Gounder, Chendalai Gounder, Pavalankatti Vellala Gounder, Palla Vellala Gounder, Sanku Vellala Gounder, & Rathinagiri Gounder)",
            },
            { name: "Koppala Velama" },
            { name: "Koteyar" },
            {
            ...
            { name: "Mahratta (NonBrahmin) (including Namadev Mahratta)" },
            { name: "Malayar" },
            { name: "Male" },
            { name: "Maniagar" },
            { name: "Maravars" },
            { name: "Moondrumandai Enbathunalu (84) Ur. Sozhia Vellalar" },
            { name: "Mooppan" },
            ...
            { name: "Omitted" },
            { name: "Kathikarar in Kanyakumari District" },
            { name: "Pannirandam Chettiar or Uthama Chettiar" },
            {
              name:
                "Parkavakulam (including Surithimar Nathamar, Malayamar, Moopanar & Nainar)",
            },
            { name: "Perike (including Perike Balija)" },
            {
              name:
            ...
            { name: "Poraya" },
            { name: "Pulavar (in Coimbatore and Erode Districts)" },
            { name: "Pulluvar or Pooluvar" },
            { name: "Pusala" },
            { name: "Reddy (Ganjam)" },
            {
              name:
            ...
            { name: "Savalakkarar" },
            { name: "Senaithalaivar, Senaikudiyar and IIaivaniar" },
            ...
            { name: "Tholuva Naicker and Vetalakara Naicker" },
            { name: "Thoriyar" },
            { name: "Ukkirakula Kshatriya Naicker" },
            { name: "Uppara, Uppillia and Sagara" },
            {
              name:
                "Urali Gounder (except Tiruchirapalli Karur, Perambalur and Pudukkottai Districts) and Orudaya Gounder or Oorudaya Gounder (in Madurai and Theni, Dindigul, Coimbatore, Erode, Tiruchirapalli, Karur, Perambalur, Pudukkottai, Salem and Namakkal Districts)",
            },
            ...
            {
              name:
                "Veduvar and Vedar (except in Kanyakumari District and Shenkottah Taluk of Tirunelveli District Where the Community is a Scheduled Castes)",
            },
            {
              name:
            ...
            { name: "Wynad Chetty (The Nilgiris District)" },
            {
              name:
            ...
            { name: "Ambalakarar" },
            { name: "Andipandaram" },
            { name: "Arayar (in Kanyakumari District)" },
            { name: "Bestha, Siviar" },
            { name: "Bhatraju (Other than Kshatriya Raju)" },
            {
              name:
                "Oddars (except Thanjavur, Nagapattinam, Thiruvarur, Tiruchirappalli, Karur, Perambalur, Pudukkottai, Madurai, Theni and Dindigul Districts)",
            },
            { name: "Dasari" },
            { name: "Dommara" },
            {
            ...
            { name: "Jangam" },
            { name: "Jogi" },
            { name: "Kongu Chettiar (in Coimbatore and Erode Districts only)" },
            { name: "Koracha" },
            { name: "Kulala (including Kuyavar and Kumbarar)" },
            { name: "Kunnuvar Mannadi" },
            { name: "Kurumba, Kurumba Goundar" },
            { name: "Kuruhini Chetty" },
            { name: "Latin Catholic Christian Vannar" },
            {
              name:
            ...
            {
              name: "Pannayar (other than Kathikarar in Kanyakumari District)",
            },
            {
              name:
            ...
            { name: "Thondaman" },
            { name: "Thoraiyar (Nilgiris)" },
            { name: "Thoraiyar (Plains)" },
            { name: "Valaiyar (including Chettinad Valayars)" },
            {
              name:
            ...
            {
              name:
                "Eravallan (Kanyakumari District and Shenkottah Taluk of Tirunelveli District)",
            },
            { name: "Irular" },
            { name: "Kadar" },
            { name: "Kammara" },
            { name: "Kanikaran, Kanikkar" },
            { name: "Kaniyan, Kanyan" },
            { name: "Kattunayakan" },
            { name: "Kochu Velan" },
            { name: "Konda Kapus" },
            ...
            { name: "Chandala" },
            { name: "Cheruman" },
            { name: "Devendrakulathan" },
            { name: "Dom, Dombara, Paidi, Pano" },
            { name: "Domban" },
            { name: "Godagali" },
            { name: "Godda" },
            { name: "Gosangi" },
            ...
            { name: "Kalladi" },
            { name: "Kanakkan, Padanna (in the Nilgiris District)" },
            { name: "Karimpalan" },
            {
              name:
            ...
            { name: "Pannadi" },
            { name: "Panniandi" },
            { name: "Paraiyan, Parayan, Sambavar" },
            {
              name:
            ...
            {
              name:
                "Pedda Boyar (except Tiruchirappalli, Karur, Perambalur and Pudukkottai Districts)",
            },
            {
              name:
            ...
            {
              name:
                "Kaloddars (except Kancheepuram, Tiruvallur, Ramanathapuram, Sivaganga, Virudhunagar, Madurai, Theni, Dindigul, Pudukkottai, Tiruchirappalli, Karur, Perambalur, Tirunelveli, Thoothukudi, Salem & Namakkal Districts)",
            },
            {
              name:
                "Nellorepet Oddars (except Vellore and Thiruvannamalai Districts) Sooramari Oddars (except Salem and Namakkal Districts)",
            },
            { name: "Sooramari Oddars (except Salem and Namakkal Districts)" },
            {
              name:
                "Kottappal Kallars (except Pudukkottai, Tiruchirapalli, Karur and Permbalur Districts)",
            },
            {
              name:
                "Orphans and destitues children who have lost their Parents before reaching the age of ten and are destitutes  and who have nobody else to take care of them either by law or custom  and also who are admitted into any of the Schools or orphanages run by the Government or recognised by the Government.",
            },
            {
              name:
            ...
            { name: "Attur Melnad Koravars (Salem and Namakkal District)" },
            {
              name:
            ...
            { name: "Dobba Koravars (Salem and Namakkal Districts)" },
            {
              name:
                "Dommars (Thanjavur, Nagapattinam, Thiruvarur, Pudukkottai, Vellore and Thiruvannamalai Districts)",
            },
            { name: "Donga Boya" },
            { name: "Donga Ur. Korachas" },
            { name: "Devagudi Talayaris" },
            {
              name:
            ...
            {
              name:
                "Koravars (Kancheepuram, Tiruvallur, Ramanathapuram, Sivaganga, Virudhunagar, Pudukkottai, Thanjavur, Nagapattinam, Thiruvarur, Tiruchirapalli, Karur, Perambalur, Tirunelveli, Thoothukudi, Chennai, Madurai, Theni, Dindigul and The Nilgiris Distrists",
            },
            {
              name:
            ...
            {
              name: "Nellorepet Oddars (Vellore and Thiruvannamalai Districts)",
            },
            {
              name:
            ...
            { name: "Ponnai Koravars (Vellore and Thiruvannamalai Districts)" },
            {
              name:
            ...
            { name: "Salem Uppu Koravars (Salem and Namakkal Districts)" },
            {
              name:
                "Sakkaraithamadai Koravars (Vellore and Thiruvannamalai districts)",
            },
            { name: "Saranga Palli Koravars" },
            { name: "Sooramari Oddars (Salem and Namakkal Districts)" },
            {
              name:
                "Sembanad Maravars (Sivaganga, Virudhunagar and Ramanathapuram Districts)",
            },
            { name: "Thalli Koravars (Salem and Namakkal Districts)" },
            {
              name:
            ...
            {
              name:
                "Thottia Naickers (Sivaganga, Virudhunagar, Ramanathapuram, Kancheepuram, Tiruvallur, Thanjavur, Nagapattinam, Karur, Tiruchirapalli, Karur, Perambalur. Pudukkottai, Tirunelveli, Thoothukudi, Salem, Namakkal, Vellore, Thiruvannamalai, Coimbatore & Erode Districts)",
            },
            {
              name:
            ...
            {
              name:
                "Uppukoravars or Settipalli Koravars (Thanjavur, Nagapattinam, Thiruvarur, Pudukkottai, Madurai, Theni, Dindigul, Vellore and Thiruvannamalai Districts)",
            },
            {
              name:
                "Urali Gounders (Tiruchirapalli, Karur, Perambalur and Pudukkottai Districts)",
            },
            { name: "Wayalpad or Nawalpeta Korachas" },
            {
              name:
            ...
            { name: "Vetta koravars (Salem and Namakkal District)" },
            {
              name:
            ...
            {
              name:
                "Piramalai Kallars (except Sivaganga, Virudhunagar, Ramanathapuram, Madurai, Theni, Dindigul, Pudukkottai, Thanjavur, Nagapattinam and Thiruvarur Districts)",
            },
            {
              name:
                "Periyasooriyur Kallars (except Tiruchirapalli, Karur, Perambalur and Pudukkottai Districts)",
            },
            {
              name:
            ...
            { name: "Boyar, Oddar" },
            {
              name: "Latin Catholic Christian Vannar (in Kanyakumari District)",
            },
            { name: "Transgender or Eunuch (Thirunangai or Aravani)" },
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        const res = yield qryManager
          .createQueryBuilder()
          .insert()
          .into(ClassSections_1.ClassSections)
          .values([
  ...
  schoolProfileAdd(qryManager) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        sp.address =
          "Thirukaneeswarar kovil Road, Seithur, Chellathai amman kovil road, Seithur";
  ...
  eduLevels(qryManager) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        throw new Error(
          `${__dirname} School Profile: Unable to save, ${error}`
        );
      }
    });
  }
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        const res = yield qryManager
          .createQueryBuilder()
          .insert()
          .into(RulesRegulations_1.RulesRegulations)
          .values([
            {
              orderby: 3,
            ...
            },
            {
              ...
              title: "Essential for an ideal student",
              entext:
                "In case of sickness / ailment inform the class teacher & meet the doctor immediately.",
              tamiltext:
                "நோய் / வியாதி ஏற்பட்டால் வகுப்பு ஆசிரியருக்கு அறிவித்து உடனடியாக மருத்துவரை சந்திக்கவும்.",
            },
            {
              orderby: 3,
              title: "Essential for an ideal student",
              ...
              tamiltext:
                "பள்ளி வளாகத்திற்குள் தொடர்பு கொள்வதற்கான அதிகாரப்பூர்வ மொழி ஆங்கிலம். ஒவ்வொரு மாணவரும் ஒருவருக்கொருவர் ஆங்கிலத்தில் தொடர்புகொள்வது அவசியம், ஏனெனில் இது பிற்கால கட்டத்தில் வேலைவாய்ப்பின் முக்கிய அங்கமாகும்.",
            },
            {
              orderby: 3,
              title: "Essential for an ideal student",
              entext:
                "Regularity, Punctuality in work and school attendance are essential.",
              tamiltext:
                "ஒழுங்குமுறை, வேலையில் நேரமின்மை மற்றும் பள்ளி வருகை அவசியம்.",
            },
            {
              orderby: 3,
              title: "Essential for an ideal student",
              entext:
                "During rainy season,carry a rain coat or an umbrella to the school.",
              tamiltext:
                "மழைக்காலங்களில், பள்ளிக்கு ஒரு நீர்புகா மேல்சட்டை அல்லது ஒரு குடையை எடுத்துச் செல்லுங்கள்.",
            },
            {
              orderby: 3,
              title: "Essential for an ideal student",
              ...
              tamiltext:
                "போக்குவரத்து விதிகளை பின்பற்றவும். சைக்கிள் ஓட்டுபவர்கள் இடதுபுறமாக இருக்க வேண்டும், ஒன்றன்பின் ஒன்றாக வர வேண்டும். சந்திப்பில் சிறிது நேரம் நிறுத்திவிட்டு, சாலையைக் கடப்பதற்கு முன் எந்தவொரு வாகனத்திற்கும் சாலையின் இருபுறமும் பாருங்கள். இரட்டையர் / மும்மடங்கு சவாரி செய்வது ஆபத்தானது மற்றும் அரசாங்க ஒழுங்குமுறைக்கு எதிரானது.",
            },
            {
              orderby: 1,
              title: "Code of conduct : Students",
              entext:
                "You are not permitted to bring story books, crackers, calculators, cell phones, electronic gadgets, playthings, game card and other unwanted materials to the school.",
              tamiltext:
                "கதை புத்தகங்கள், பட்டாசுகள், கால்குலேட்டர்கள், செல்போன்கள், மின்னணு கேஜெட்டுகள், விளையாட்டு பொருட்கள் மற்றும் பிற தேவையற்ற பொருட்களை பள்ளிக்கு கொண்டு வர உங்களுக்கு அனுமதி இல்லை.",
            },
            {
              orderby: 1,
              title: "Code of conduct : Students",
              ...
              tamiltext:
                "ஏதேனும் வியாதி ஏற்பட்டால், நோய் முழுமையாக குணமாகும் வரை, தேர்வு நாட்களில் கூட நீங்கள் பள்ளிக்கு வர வேண்டியதில்லை. மருத்துவ சான்றிதழ் சமர்ப்பிக்கப்பட வேண்டும்.",
            },
            {
              orderby: 1,
              title: "Code of conduct : Students",
              entext:
                "Attendance is compulsory for national festivals and school functions.",
              tamiltext:
                "தேசிய விழாக்கள் மற்றும் பள்ளி விழாக்களுக்கு வருகை கட்டாயமாகும்.",
            },
            {
              orderby: 1,
              title: "Code of conduct : Students",
              entext:
                "Note that student indulging in malpractice in the examinations will be given zero in the subject besides the disciplinary action taken against them.",
              tamiltext:
                "பரீட்சைகளில் முறைகேட்டில் ஈடுபடும் மாணவர்களுக்கு பாடத்தில் பூஜ்ஜியம் வழங்கப்படும் என்பதை நினைவில் கொள்க வேண்டும்.",
            },
            {
              orderby: 4,
              title: "Maintenance of note books & text books",
              entext:
                "Number all the pages of the note books. Do not detach any paper from the notebooks.",
              tamiltext:
                "புத்தகங்களிலிருந்து எந்த காகிதத்தையும் பிரிக்க/கிழிக்கக்கூடாது.",
            },
            {
              orderby: 4,
              title: "Maintenance of note books & text books",
            ...
            },
            {
              ...
              title: "Maintenance of note books & text books",
              entext:
                "Submit home assignments, activities, projects, class work-notebooks for correction within the stipulated time.",
              tamiltext:
                "நிர்ணயிக்கப்பட்ட நேரத்திற்குள் வீட்டுப்பாடம், செயல்பாடுகள், திட்டங்கள், வகுப்பு வேலை-குறிப்பேடுகள் ஆகியவற்றைச் சமர்ப்பிக்கவும்.",
            },
            {
              orderby: 2,
              title: "To the parents",
              entext:
                "Parents are requested to send their children neat and tidy and see that the children are punctual to the school.",
              tamiltext:
                "பெற்றோர்கள் தங்கள் குழந்தைகளை நேர்த்தியாகவும் நேர்த்தியாகவும் அனுப்பவும், குழந்தைகள் சரியான நேரத்தில் பள்ளிக்கு வருவதைக் காணவும் கேட்டுக்கொள்ளப்படுகிறார்கள்.",
            },
            {
              orderby: 2,
              title: "To the parents",
              entext:
                "Parents are also expected to co-operate with the school management and staff regarding discipline and studies.",
              tamiltext:
                "ஒழுக்கம் மற்றும் படிப்பு தொடர்பாக பள்ளி நிர்வாகம் மற்றும் ஊழியர்களுடன் பெற்றோர்கள் ஒத்துழைப்பார்கள் என்று எதிர்பார்க்கப்படுகிறது.",
            },
            {
              orderby: 2,
              title: "To the parents",
              entext:
                "Parent signature in the progress card is a must after every test and examination.",
              tamiltext:
                "ஒவ்வொரு அட்டை மற்றும் பரீட்சைக்குப் பிறகும் முன்னேற்ற அட்டையில் பெற்றோர் கையொப்பம் அவசியம்.",
            },
            {
              orderby: 2,
              title: "To the parents",
              entext:
                "The Parents are expected to meet the Principal or class teacher if the child’s progress is not satisfactory.",
              tamiltext:
                "குழந்தையின் முன்னேற்றம் திருப்திகரமாக இல்லாவிட்டால், பெற்றோர் முதல்வர் அல்லது வகுப்பு ஆசிரியரை சந்திப்பார்கள் என்று எதிர்பார்க்கப்படுகிறது.",
            },
            {
              orderby: 2,
              title: "To the parents",
              entext:
                "Parents co-operation with the school management and staff regarding discipline and regularity in home work will be highly appreciated.",
              tamiltext:
                "வீட்டு வேலைகளில் ஒழுக்கம் மற்றும் ஒழுங்குமுறை குறித்து பள்ளி நிர்வாகம் மற்றும் ஊழியர்களுடன் பெற்றோரின் ஒத்துழைப்பு மிகவும் பாராட்டப்படும்.",
            },
            {
              orderby: 2,
              title: "To the parents",
              entext:
                "Students including L.K.G. are asked to bring lunch to the school and they can take their lunch in the school premises. Kindly send the lunch kit with all necessary things in it.",
              tamiltext:
                "எல்.கே.ஜி உள்ளிட்ட மாணவர்கள். பள்ளிக்கு மதிய உணவைக் கொண்டு வரும்படி கேட்கப்படுகிறார்கள், அவர்கள் மதிய உணவை பள்ளி வளாகத்தில் எடுத்துக் கொள்ளலாம். தயவுசெய்து தேவையான அனைத்து பொருட்களையும் கொண்டு மதிய உணவு கிட் அனுப்பவும்.",
            },
            {
              orderby: 2,
              title: "To the parents",
              entext:
                "Parents are advised to meet the teacher concerned on any day to discuss about the progress of the students from 4.00 p.m. to 4.30 p.m.",
              tamiltext:
                "மாலை 4.00 மணி முதல் மாணவர்களின் முன்னேற்றம் குறித்து விவாதிக்க பெற்றோர்கள் எந்த நாளிலும் சம்பந்தப்பட்ட ஆசிரியரை சந்திக்க அறிவுறுத்தப்படுகிறார்கள். மாலை 4.30 மணி முதல்.",
            },
            {
              orderby: 2,
              title: "To the parents",
              entext:
                "The progress of the students depends on the co-operation of the teacher and parent. Hence the parent or guardian are requested to refer the Hand Book of their children regularly and make them to do their homework daily.",
              tamiltext:
                "மாணவர்களின் முன்னேற்றம் ஆசிரியர் மற்றும் பெற்றோரின் ஒத்துழைப்பைப் பொறுத்தது. எனவே பெற்றோர் அல்லது பாதுகாவலர் தங்கள் குழந்தைகளின் கை புத்தகத்தை தவறாமல் பார்க்கவும், தினசரி வீட்டுப்பாடங்களைச் செய்யும்படி கேட்டுக்கொள்ளப்படுகிறார்கள்.",
            },
          ])
          .execute();
        return res;
