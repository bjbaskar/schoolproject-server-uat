...
class Bootstrap {
    constructor() {
        ...
        this.ROLE_ID = "";
        dotenv.config();
        const DB_HOST = "database-1.cptqfr4rrvw1.us-east-2.rds.amazonaws.com";
        const DB_NAME = "database-1";
        const USERNAME = "admin";
        const PASSWORD = "AoPkNj2PSNKNwhWfPvCd";
        const DB_PORT = 3306;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const res = yield qryManager
                    ...
                    { name: "Alwar, Azhavar and Alavar (in Kanyakumari District and Shenkottah Taluk of Tirunelveli District)" },
                    { name: "Servai (except Tiruchirappalli, Karur, Perambalur and Pudukkottai Districts)" },
                    { name: "Nulayar (in Kanyakumari District and Shenkottah Taluk of Tirunelveli District)" },
                    { name: "Archakarai Vellala" },
                    { name: "Aryavathi (in Kanyakumari District and Shenkottah Taluk of Tirunelveli District)" },
                    { name: "Ayira Vaisyar" },
                    { name: "Badagar" },
                    { name: "Billava" },
                    { name: "Bondil" },
                    { name: "Boyas (except Tiruchirappalli, Karur, Perambalur, Pudukkottai, The Nilgiris, Salem, Namakkal and Dharmapuri and Krishnagiri Districts)" },
                    { name: "Chakkala (except Sivaganga, Virudhunagar, Ramanathapuram, Thanjavur, Nagapattinam, Thiruvarur, Pudukkottai, Tiruchirappalli, Karur, Perambalur, Madurai, Theni, Dindigul and The Nilgiris Districts)" },
                    { name: "Chavalakarar (in Kanyakumari District and Shenkottah Taluk of Tirunelveli District)" },
                    { name: "Chettu or Chetty (including Kottar Chetty, Elur Chetty, Pathira Chetty, Valayal Chetty, Pudukadai Chetty) (in Kanyakumari District and Shenkottah Taluk of Tirunelveli District)" },
                    { name: "Chowdry" },
                    { name: "C.S.I. formerly S.I.U.C. (in Kanyakumari District and Shenkottah Taluk of Tirunelveli District)" },
                    ...
                    { name: "Monda Koravars" }, { name: "Monda Golla (Salem and Namakkal Districts)" },
                    { name: "Mutlakampatti (Tiruchirapalli, Karur, Perambalur and Pudukkottai Districts)" },
                    { name: "Nokkars (Tiruchirapalli, Karur, Perambalur and Pudukkottai Districts)" },
                    { name: "Nellorepet Oddars (Vellore and Thiruvannamalai Districts)" },
                    { name: "Oddars (Thanjavur, Nagapattinam, Thiruvarur, Tiruchirapalli, Karur, Perambalur, Pudukkottai, Madurai, Theni and Dindigul Districts)" },
                    { name: "Pedda Boyas (Tiruchirapalli, Karur, Perambalur and Pudukkottai Districts)" },
                    { name: "Ponnai Koravars (Vellore and Thiruvannamalai Districts)" },
                    { name: "Piramalai Kallars (Sivagangai, Virudhunagar, Ramanathapuram, Madurai, Theni, Dindigul, Pudukkottai, Thanjavur, Nagapattinam and Thiruvarur Districts)" },
                    { name: "Periya Suriyur Kallars (Tiruchirapalli, Karur, Perambalur, and Pudukkottai Districts)" },
                    { name: "Padayachi (Vellayan Kuppam in Cuddalore District and Tennore in Tiruchirapalli District)" },
                    { name: "Punnan Vettuva Gounder (Tiruchirapalli, Karur, Perambalur and Pudukkottai Districts)" },
                    { name: "Servai (Tiruchirapalli, Karur, Perambalur and Pudukkottai Districts)" },
                    { name: "Salem Melnad Koravars (Madurai, Theni, Dindigul, Coimbatore, Erode, Pudukkottai, Tiruchirapalli, Karur, Perambalur, Salem, Namakkal, Vellore and Thiruvannamalai Districts)" },
                    { name: "Salem Uppu Koravars (Salem and Namakkal Districts)" },
                    { name: "Sakkaraithamadai Koravars (Vellore and Thiruvannamalai districts)" },
                    { name: "Saranga Palli Koravars" }, { name: "Sooramari Oddars (Salem and Namakkal Districts)" },
                    { name: "Sembanad Maravars (Sivaganga, Virudhunagar and Ramanathapuram Districts)" },
                    { name: "Thalli Koravars (Salem and Namakkal Districts)" },
                    { name: "Telungapatti Chettis (Tiruchirapalli, Karur, Perambalur and Pudukkottai Districts)" },
                    { name: "Thottia Naickers (Sivaganga, Virudhunagar, Ramanathapuram, Kancheepuram, Tiruvallur, Thanjavur, Nagapattinam, Karur, Tiruchirapalli, Karur, Perambalur. Pudukkottai, Tirunelveli, Thoothukudi, Salem, Namakkal, Vellore, Thiruvannamalai, Coimbatore & Erode Districts)" },
                    { name: "Thogamalai Koravars or Kepmaris (Tiruchirapalli, Karur, Perambalur and Pudukkottai Districts)" },
                    { name: "Uppukoravars or Settipalli Koravars (Thanjavur, Nagapattinam, Thiruvarur, Pudukkottai, Madurai, Theni, Dindigul, Vellore and Thiruvannamalai Districts)" },
                    { name: "Urali Gounders (Tiruchirapalli, Karur, Perambalur and Pudukkottai Districts)" },
                    { name: "Wayalpad or Nawalpeta Korachas" },
                    { name: "Vaduvarpatti Koravars (Madurai, Theni, Dindigul, Ramanathapuram, Sivaganga, Virudhunagar, Tirunelveli, Thoothukudi, Tiruchirapalli, Karur, Perambalur and Pudukkottai Districts)" }, { name: "Valayars (Madurai, Theni, Dindigul, Tiruchirapalli, Karur, Perambalur, Pudukkottai, Erode and Coimbatore Districts)" }, { name: "Vettaikarar (Thanjavur, Nagapattinam, Thiruvarur and Pudukkottai Districts)" }, { name: "Vetta koravars (Salem and Namakkal District)" }, { name: "Varaganeri Koravars (Tiruchirapalli, Karur, Perambalur and Pudukkottai Districts)" }, { name: "Vettuva Gounder (Tiruchirapalli, Karur, Perambalur and Pudukkottai Districts)" }, { name: "General" }, { name: "Piramalai Kallars (except Sivaganga, Virudhunagar, Ramanathapuram, Madurai, Theni, Dindigul, Pudukkottai, Thanjavur, Nagapattinam and Thiruvarur Districts)" }, { name: "Periyasooriyur Kallars (except Tiruchirapalli, Karur, Perambalur and Pudukkottai Districts)" }, { name: "Converts to Christianity from Scheduled Castes irrespective of the generation of conversion (except the Paravar converts to Christianity of Kanyakumari District and Shenkottah Taluk of Tirunelveli District)" }, { name: "Boyar, Oddar" }, { name: "Latin Catholic Christian Vannar (in Kanyakumari District)" }, { name: "Transgender or Eunuch (Thirunangai or Aravani)" },
                ])
                    .execute();
                return res;
            }
            catch (error) {
                throw new Error(`casteAdd Error ${error}`);
            }
        });
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const res = yield qryManager
                    ...
                    { name: "PROMOTION_REASON", value: "Course completed" },
                    { name: "PROMOTION_REASON", value: "Transfer to another city" },
                    { name: "PROMOTION_REASON", value: "Move to other school" },
                    { name: "PROMOTION_REASON", value: "Others" },
                    { name: "FEE_PERIOD", value: "Monthly Fee" },
                    { name: "FEE_PERIOD", value: "Term Fee" },
                    { name: "FEE_PERIOD", value: "Annual Fee" },
                    { name: "FEE_PERIOD", value: "One Time Fee" },
                    { name: "PAY_MODE", value: "Cash" },
                    { name: "PAY_MODE", value: "Cheque" },
                    { name: "PAY_MODE", value: "Demand Draft (DD)" },
                    { name: "PAY_MODE", value: "Netbanking" },
                    { name: "PAY_MODE", value: "Online transfer" },
                    { name: "PAY_MODE", value: "Others" },
                ])
                    .execute();
                return res;
            }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const res = yield qryManager
                    ...
                    .values([
                    { name: "Tamil", subcode: "TA00", color: "#ffcdd2", createdby: this.currentUser },
                    { name: "Tamil I", subcode: "TA01", color: "#f8bbd0", createdby: this.currentUser },
                    { name: "Tamil II", subcode: "TA02", color: "#e1bee7", createdby: this.currentUser },
                    { name: "English", subcode: "EN00", color: "#d1c4e9", createdby: this.currentUser },
                    { name: "English I", subcode: "EN01", color: "#c5cae9", createdby: this.currentUser },
                    { name: "English II", subcode: "EN02", color: "#bbdefb", createdby: this.currentUser },
                    { name: "Mathematics", subcode: "M00", color: "#b3e5fc", createdby: this.currentUser },
                    { name: "Mathematics I", subcode: "M01", color: "#b2ebf2", createdby: this.currentUser },
                    { name: "Mathematics II", subcode: "M02", color: "#b2dfdb", createdby: this.currentUser },
                    { name: "Science", subcode: "SC01", color: "#c8e6c9", createdby: this.currentUser },
                    { name: "General Knowledge", subcode: "GK01", color: "#aed581", createdby: this.currentUser },
                    { name: "Alphabet", subcode: "ALP01", color: "#cddc39", createdby: this.currentUser },
                    { name: "Numbers", subcode: "NUM01", color: "#ffeb3b", createdby: this.currentUser },
                    { name: "Rhymes", subcode: "RHY01", color: "#ffc107", createdby: this.currentUser },
                    { name: "Story Telling", subcode: "ST01", color: "#ff9800", createdby: this.currentUser },
                    { name: "Drawing", subcode: "DRW01", color: "#ff8a65", createdby: this.currentUser },
                    { name: "Hindi", subcode: "HIN01", color: "#a1887f", createdby: this.currentUser },
                    { name: "Computer Science", subcode: "CS01", color: "#90a4ae", createdby: this.currentUser },
                    { name: "Moral Science", subcode: "MS01", color: "#d9d9d9", createdby: this.currentUser },
                ])
                    .execute();
                return res;
            }
